!(function (t, e) {
        ...
        Z = (function () {
            function o(t, e) {
                ...
                (function (t, e) {
                    ...
                    (this.options = Y({}, o.Defaults, s)),
                    (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
                    (this.reference = t.jquery ? t[0] : t),
                    (this.popper = e.jquery ? e[0] : e),
                    (this.options.modifiers = {}),
                    Object.keys(Y({}, o.Defaults.modifiers, s.modifiers)).forEach(function (t) {
                        ...
                        return (
                            y.forEach(function (t, e) {
                                ...
                                (r || u || p) &&
                                    ...
                                    (f.placement = v + (b ? "-" + b : "")),
                                    (f.offsets.popper = Y({}, f.offsets.popper, T(f.instance.popper, f.offsets.reference, f.placement))),
                                    (f = P(f.instance.modifiers, f, "flip")));
                            }),
                            f
                        );
                    },
                ...
                computeStyle: {
                    ...
                    fn: function (t, e) {
                        ...
                        var r,
                            ...
                            f = F("transform");
                        if (((a = "bottom" == d ? -h.height + u.bottom : u.top), (r = "right" == p ? -h.width + u.right : u.left), l && f))
                            (c[f] = "translate3d(" + r + "px, " + a + "px, 0)"), (c[d] = 0), (c[p] = 0), (c.willChange = "transform");
                        else {
                            var g = "bottom" == d ? -1 : 1,
                                m = "right" == p ? -1 : 1;
    ...
    (function (t, e) {
        ...
        var n,
            ...
            Ri =
                    ...
                    return (
                        ...
                        (t._removeElement = function (e) {
                            ...
                            if ((n(e).removeClass(f), n(e).hasClass(p))) {
                                ...
                                n(e)
                                    .one(Li.TRANSITION_END, function (t) {
                ...
                n(document).on(u.CLICK_DATA_API, '[data-dismiss="alert"]', g._handleDismiss(new g())),
            ...
            ji =
                ...
                (S = ".active"),
                (T = ".btn"),
                (A = { CLICK_DATA_API: "click" + b + y, FOCUS_BLUR_DATA_API: (x = "focus") + b + y + " blur" + b + y }),
                (P = (function () {
                    function i(t) {
                        this._element = t;
                    }
                ...
                (m.fn[v] = P._jQueryInterface),
                (m.fn[v].Constructor = P),
            ...
            qi =
                ...
                (j = "left"),
                (q = "right"),
                (B = { SLIDE: "slide" + O, SLID: "slid" + O, KEYDOWN: "keydown" + O, MOUSEENTER: "mouseenter" + O, MOUSELEAVE: "mouseleave" + O, TOUCHEND: "touchend" + O, LOAD_DATA_API: "load" + O + z, CLICK_DATA_API: "click" + O + z }),
                (Y = "carousel"),
                (K = "active"),
                (U = "slide"),
                    ...
                    return (
                        ...
                        (t.to = function (t) {
                            ...
                            if (!(t > this._items.length - 1 || t < 0))
                                if (this._isSliding)
                                    F(this._element).one(B.SLID, function () {
                                        return e.to(t);
                                    });
                                else {
                        ...
                        (t.dispose = function () {
                            F(this._element).off(O),
                                F.removeData(this._element, N),
                                (this._items = null),
                                (this._config = null),
                                (this._element = null),
                                (this._interval = null),
                        ...
                        (t._addEventListeners = function () {
                            ...
                            this._config.keyboard &&
                                F(this._element).on(B.KEYDOWN, function (t) {
                                    return e._keydown(t);
                                }),
                                "hover" === this._config.pause &&
                                    (F(this._element)
                                        .on(B.MOUSEENTER, function (t) {
                                            return e.pause(t);
                                        })
                                    ...
                                    "ontouchstart" in document.documentElement &&
                                        F(this._element).on(B.TOUCHEND, function () {
                                            e.pause(),
                        ...
                        (t._slide = function (t, e) {
                            ...
                            if ((t === L ? ((i = V), (s = X), (n = j)) : ((i = Q), (s = Z), (n = q)), l && F(l).hasClass(K))) this._isSliding = !1;
                                ...
                                if (F(this._element).hasClass(U)) {
                                    ...
                                    F(r)
                                        .one(Li.TRANSITION_END, function () {
                                            F(l)
                                                .removeClass(i + " " + s)
                                                .addClass(K),
                                                F(r).removeClass(K + " " + s + " " + i),
                                                (o._isSliding = !1),
                                                setTimeout(function () {
                ...
                F(document).on(B.CLICK_DATA_API, st, ot._dataApiClickHandler),
                F(window).on(B.LOAD_DATA_API, function () {
                    for (var t = [].slice.call(document.querySelectorAll(nt)), e = 0, i = t.length; e < i; e++) {
                        var s = F(t[e]);
                        ot._jQueryInterface.call(s, s.data());
                    }
                }),
                (F.fn[M] = ot._jQueryInterface),
                (F.fn[M].Constructor = ot),
            ...
            Bi =
                ...
                (Ct = (function () {
                    function a(e, t) {
                        (this._isTransitioning = !1),
                            ...
                            (this._triggerArray = rt.makeArray(document.querySelectorAll('[data-toggle="collapse"][href="#' + e.id + '"],[data-toggle="collapse"][data-target="#' + e.id + '"]')));
                    ...
                    return (
                        ...
                        (t.show = function () {
                            ...
                            if (
                                ...
                                !rt(this._element).hasClass(ft) &&
                                (this._parent &&
                                    0 ===
                                        (t = [].slice.call(this._parent.querySelectorAll(yt)).filter(function (t) {
                                            return t.getAttribute("data-parent") === i._config.parent;
                                        })).length &&
                                    (t = null),
                                !(t && (e = rt(t).not(this._selector).data(lt)) && e._isTransitioning))
                            ) {
                ...
                (rt.fn[at] = Ct._jQueryInterface),
                (rt.fn[at].Constructor = Ct),
                (rt.fn[at].noConflict = function () {
            ...
            Yi =
                ...
                (At = { HIDE: "hide" + Et, HIDDEN: "hidden" + Et, SHOW: "show" + Et, SHOWN: "shown" + Et, CLICK: "click" + Et, CLICK_DATA_API: "click" + Et + It, KEYDOWN_DATA_API: "keydown" + Et + It, KEYUP_DATA_API: "keyup" + Et + It }),
                (Pt = "disabled"),
                (Ft = "show"),
                (Mt = "dropup"),
                (Nt = "dropright"),
                ...
                (Zt = (function () {
                    ...
                    return (
                                ...
                                if ((h._clearMenus(), !e)) {
                                    ...
                                    if ((Dt(t).trigger(s), !s.isDefaultPrevented())) {
                                        if (!this._inNavbar) {
                                            ...
                                            var n = this._element;
                                            "parent" === this._config.reference ? (n = t) : Li.isElement(this._config.reference) && ((n = this._config.reference), void 0 !== this._config.reference.jquery && (n = this._config.reference[0])),
                                                "scrollParent" !== this._config.boundary && Dt(t).addClass(Ht),
                                                (this._popper = new c(n, this._menu, this._getPopperConfig()));
                                        }
                                        "ontouchstart" in document.documentElement && 0 === Dt(t).closest(Rt).length && Dt(document.body).children().on("mouseover", null, Dt.noop),
                                            this._element.focus(),
                                            this._element.setAttribute("aria-expanded", !0),
                                            Dt(this._menu).toggleClass(Ft),
                                            Dt(t).toggleClass(Ft).trigger(Dt.Event(At.SHOWN, i));
                                    }
                                }
                            }
                        }),
                                        ...
                                        if (Dt(n).hasClass(Ft) && !(t && (("click" === t.type && /input|textarea/i.test(t.target.tagName)) || ("keyup" === t.type && 9 === t.which)) && Dt.contains(n, t.target))) {
                                            ...
                                            Dt(n).trigger(l),
                                                l.isDefaultPrevented() ||
                                                    ...
                                                    Dt(a).removeClass(Ft),
                                                    Dt(n).removeClass(Ft).trigger(Dt.Event(At.HIDDEN, r)));
                                        }
                                    }
                                }
                        }),
                        (h._getParentFromElement = function (t) {
                            var e,
                                i = Li.getSelectorFromElement(t);
                            return i && (e = document.querySelector(i)), e || t.parentNode;
                        }),
                        (h._dataApiKeydownHandler = function (t) {
                            if (
                                (/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || (27 !== t.which && ((40 !== t.which && 38 !== t.which) || Dt(t.target).closest(Lt).length))) : Tt.test(t.which)) &&
                                (t.preventDefault(), t.stopPropagation(), !this.disabled && !Dt(this).hasClass(Pt))
                            ) {
                ...
                Dt(document)
                    .on(At.KEYDOWN_DATA_API, Wt, Zt._dataApiKeydownHandler)
                    .on(At.KEYDOWN_DATA_API, Lt, Zt._dataApiKeydownHandler)
                    .on(At.CLICK_DATA_API + " " + At.KEYUP_DATA_API, Zt._clearMenus)
                ...
                (Dt.fn[xt] = Zt._jQueryInterface),
                (Dt.fn[xt].Constructor = Zt),
                (Dt.fn[xt].noConflict = function () {
            ...
            Ki =
                ...
                (ne = { backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean" }),
                (oe = {
                    HIDE: "hide" + ee,
                    HIDDEN: "hidden" + ee,
                    SHOW: "show" + ee,
                ...
                (ce = "show"),
                (ue = ".modal-dialog"),
                (de = '[data-toggle="modal"]'),
                (pe = '[data-dismiss="modal"]'),
                ...
                (me = (function () {
                    ...
                    return (
                            ...
                            if (!this._isTransitioning && !this._isShown) {
                                ...
                                Gt(this._element).trigger(i),
                                    this._isShown ||
                                        ...
                                        this._setScrollbar(),
                                        this._adjustDialog(),
                                        Gt(document.body).addClass(le),
                                        this._setEscapeEvent(),
                                        this._setResizeEvent(),
                                        Gt(this._element).on(oe.CLICK_DISMISS, pe, function (t) {
                                            return e.hide(t);
                                        }),
                            ...
                            if ((t && t.preventDefault(), !this._isTransitioning && this._isShown)) {
                                ...
                                if ((Gt(this._element).trigger(i), this._isShown && !i.isDefaultPrevented())) {
                                    ...
                                    if (
                                        ...
                                        this._setEscapeEvent(),
                                        this._setResizeEvent(),
                                        Gt(document).off(oe.FOCUSIN),
                                        Gt(this._element).removeClass(ce),
                                        Gt(this._element).off(oe.CLICK_DISMISS),
                                        Gt(this._dialog).off(oe.MOUSEDOWN_DISMISS),
                                        s)
                                    ) {
                        ...
                        (t.dispose = function () {
                            Gt.removeData(this._element, te),
                                Gt(window, document, this._element, this._backdrop).off(ee),
                                (this._config = null),
                                (this._element = null),
                                (this._dialog = null),
                                (this._backdrop = null),
                        ...
                        (t._showElement = function (t) {
                            ...
                            (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE) || document.body.appendChild(this._element),
                                ...
                                i && Li.reflow(this._element),
                                Gt(this._element).addClass(ce),
                                this._config.focus && this._enforceFocus();
                            var s = Gt.Event(oe.SHOWN, { relatedTarget: t }),
                                n = function () {
                        ...
                        (t._setEscapeEvent = function () {
                            ...
                            this._isShown && this._config.keyboard
                                ? Gt(this._element).on(oe.KEYDOWN_DISMISS, function (t) {
                        ...
                        (t._setResizeEvent = function () {
                            var e = this;
                            this._isShown
                                ? Gt(window).on(oe.RESIZE, function (t) {
                        ...
                        (t._showBackdrop = function (t) {
                            ...
                            if (this._isShown && this._config.backdrop) {
                                if (
                                    ...
                                    Gt(this._element).on(oe.CLICK_DISMISS, function (t) {
                                        e._ignoreBackdropClick ? (e._ignoreBackdropClick = !1) : t.target === t.currentTarget && ("static" === e._config.backdrop ? e._element.focus() : e.hide());
                                    }),
                                    i && Li.reflow(this._backdrop),
                                    Gt(this._backdrop).addClass(ce),
                                    !t)
                                )
                                    return;
                                if (!i) return void t();
                ...
                (Gt.fn[Jt] = me._jQueryInterface),
                (Gt.fn[Jt].Constructor = me),
            ...
            Ui =
                    ...
                    return (
                        ...
                        (t.toggle = function (t) {
                            if (this._isEnabled)
                                if (t) {
                                    ...
                                    i || ((i = new this.constructor(t.currentTarget, this._getDelegateConfig())), ve(t.currentTarget).data(e, i)),
                        ...
                        (t.dispose = function () {
                            clearTimeout(this._timeout),
                                ve.removeData(this.element, this.constructor.DATA_KEY),
                                ve(this.element).off(this.constructor.EVENT_KEY),
                                ve(this.element).closest(".modal").off("hide.bs.modal"),
                                this.tip && ve(this.tip).remove(),
                        ...
                        (t.show = function () {
                            ...
                            if (this.isWithContent() && this._isEnabled) {
                                ...
                                ve(s).data(this.constructor.DATA_KEY, this),
                                    ve.contains(this.element.ownerDocument.documentElement, this.tip) || ve(s).appendTo(a),
                                    ve(this.element).trigger(this.constructor.Event.INSERTED),
                                    (this._popper = new c(this.element, s, {
                                        placement: r,
                                        modifiers: { offset: { offset: this.config.offset }, flip: { behavior: this.config.fallbackPlacement }, arrow: { element: Me }, preventOverflow: { boundariesElement: this.config.boundary } },
                                        onCreate: function (t) {
                                    ...
                                    ve(s).addClass(Pe),
                                    "ontouchstart" in document.documentElement && ve(document.body).children().on("mouseover", null, ve.noop);
                                var l = function () {
                        ...
                        (t.hide = function (t) {
                            var e = this,
                                ...
                                n = function () {
                                    e._hoverState !== Ie && i.parentNode && i.parentNode.removeChild(i),
                                        e._cleanTipClass(),
                                        e.element.removeAttribute("aria-describedby"),
                                        ve(e.element).trigger(e.constructor.Event.HIDDEN),
                        ...
                        (t._setListeners = function () {
                            ...
                            this.config.trigger.split(" ").forEach(function (t) {
                                if ("click" === t)
                                    ve(s.element).on(s.constructor.Event.CLICK, s.config.selector, function (t) {
                                        return s.toggle(t);
                                    });
                                else if (t !== He) {
                        ...
                        (t._enter = function (t, e) {
                            ...
                            (e = e || ve(t.currentTarget).data(i)) || ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), ve(t.currentTarget).data(i, e)),
                                t && (e._activeTrigger["focusin" === t.type ? Oe : Ne] = !0),
                                ve(e.getTipElement()).hasClass(Pe) || e._hoverState === Ie
                                    ? (e._hoverState = Ie)
                        ...
                        (t._leave = function (t, e) {
                            var i = this.constructor.DATA_KEY;
                            (e = e || ve(t.currentTarget).data(i)) || ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), ve(t.currentTarget).data(i, e)),
                                t && (e._activeTrigger["focusout" === t.type ? Oe : Ne] = !1),
                        ...
                        (t._getConfig = function (t) {
                            return (
                                "number" == typeof (t = l({}, this.constructor.Default, ve(this.element).data(), "object" == typeof t && t ? t : {})).delay && (t.delay = { show: t.delay, hide: t.delay }),
                                "number" == typeof t.title && (t.title = t.title.toString()),
                                "number" == typeof t.content && (t.content = t.content.toString()),
                                Li.typeCheckConfig(_e, t, this.constructor.DefaultType),
                                t
                            );
                        }),
                ...
                (ve.fn[_e] = We._jQueryInterface),
                (ve.fn[_e].Constructor = We),
                (ve.fn[_e].noConflict = function () {
            ...
            Qi =
                ...
                (Ue = l({}, Ui.DefaultType, { content: "(string|element|function)" })),
                (Qe = "fade"),
                (Xe = ".popover-header"),
                (Ze = ".popover-body"),
                (Ge = {
                ...
                ($e.fn[Le] = Je._jQueryInterface),
                ($e.fn[Le].Constructor = Je),
            ...
            Vi =
                ...
                (si = "." + (ii = "bs.scrollspy")),
                (ni = (ti = e).fn[ei]),
                (oi = { offset: 10, method: "auto", target: "" }),
                (ri = { offset: "number", method: "string", target: "(string|element)" }),
                (ai = { ACTIVATE: "activate" + si, SCROLL: "scroll" + si, LOAD_DATA_API: "load" + si + ".data-api" }),
                (li = "dropdown-item"),
                (hi = "active"),
                (ci = '[data-spy="scroll"]'),
                (ui = ".active"),
                ...
                (wi = (function () {
                    function i(t, e) {
                        ...
                        (this._element = t),
                            ...
                            (this._config = this._getConfig(e)),
                            (this._selector = this._config.target + " " + pi + "," + this._config.target + " " + gi + "," + this._config.target + " " + vi),
                            (this._offsets = []),
                            (this._targets = []),
                            (this._activeTarget = null),
                            (this._scrollHeight = 0),
                            ti(this._scrollElement).on(ai.SCROLL, function (t) {
                                return i._process(t);
                            }),
                            this.refresh(),
                            this._process();
                    ...
                    return (
                        ...
                        (t.dispose = function () {
                            ti.removeData(this._element, ii),
                                ti(this._scrollElement).off(si),
                                (this._element = null),
                        ...
                        (t._activate = function (e) {
                            ...
                            i.hasClass(li)
                                ? (i.closest(mi).find(_i).addClass(hi), i.addClass(hi))
                                : (i.addClass(hi),
                                  i
                                      .parents(di)
                                      .prev(pi + ", " + gi)
                                      .addClass(hi),
                                  i.parents(di).prev(fi).children(pi).addClass(hi)),
                                ti(this._scrollElement).trigger(ai.ACTIVATE, { relatedTarget: e });
                        }),
                        (t._clear = function () {
                ...
                (ti.fn[ei] = wi._jQueryInterface),
                (ti.fn[ei].Constructor = wi),
                (ti.fn[ei].noConflict = function () {
            ...
            Xi =
                ((xi = "." + (Di = "bs.tab")),
                (ki = (Ci = e).fn.tab),
                (Ei = { HIDE: "hide" + xi, HIDDEN: "hidden" + xi, SHOW: "show" + xi, SHOWN: "shown" + xi, CLICK_DATA_API: "click" + xi + ".data-api" }),
                (Ii = "dropdown-menu"),
                (Si = "active"),
                (Ti = "disabled"),
                (Ai = "fade"),
                ...
                (Ni = ".active"),
                (Oi = "> li > .active"),
                (zi = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]'),
                (Hi = ".dropdown-toggle"),
                    ...
                    return (
                        (t.show = function () {
                            ...
                            if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && Ci(this._element).hasClass(Si)) || Ci(this._element).hasClass(Ti))) {
                                var t,
                                    s,
                                    e = Ci(this._element).closest(Mi)[0],
                                    n = Li.getSelectorFromElement(this._element);
                                if (e) {
                                    var o = "UL" === e.nodeName ? Oi : Ni;
                                    s = (s = Ci.makeArray(Ci(e).find(o)))[s.length - 1];
                                }
                                var r = Ci.Event(Ei.HIDE, { relatedTarget: this._element }),
                                    a = Ci.Event(Ei.SHOW, { relatedTarget: s });
                ...
                (Ci.fn.tab = $i._jQueryInterface),
                (Ci.fn.tab.Constructor = $i),
            ...
            b.ui.plugin.add("draggable", "snap", {
                ...
                drag: function (t, e) {
                    for (
                        ...
                        if (
                            (c - n < o && o < u + n && d - n < a && a < p + n) ||
                            (c - n < o && o < u + n && d - n < l && l < p + n) ||
                            (c - n < r && r < u + n && d - n < a && a < p + n) ||
                            (c - n < r && r < u + n && d - n < l && l < p + n)
                        ) {
                            if ("inner" != s.snapMode) {
                                var f = Math.abs(d - l) <= n,
                                    ...
                                    m = Math.abs(c - r) <= n,
                                    v = Math.abs(u - o) <= n;
                                f && (e.position.top = i._convertPositionTo("relative", { top: d - i.helperProportions.height, left: 0 }).top - i.margins.top),
                                    g && (e.position.top = i._convertPositionTo("relative", { top: p, left: 0 }).top - i.margins.top),
                            ...
                            if ("outer" != s.snapMode) {
                                ...
                                f && (e.position.top = i._convertPositionTo("relative", { top: d, left: 0 }).top - i.margins.top),
                                    g && (e.position.top = i._convertPositionTo("relative", { top: p - i.helperProportions.height, left: 0 }).top - i.margins.top),
                            ...
                            !i.snapElements[h].snapping && (f || g || m || v || _) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, b.extend(i._uiHash(), { snapItem: i.snapElements[h].item })),
    ...
    (function (p, t) {
        p.widget("ui.droppable", {
            ...
            _create: function () {
                ...
                (this.isover = 0),
                    (this.isout = 1),
                    (this.accept = p.isFunction(e)
                        ? e
                        : function (t) {
                              return t.is(e);
                          }),
                    (this.proportions = { width: this.element[0].offsetWidth, height: this.element[0].offsetHeight }),
                    (p.ui.ddmanager.droppables[t.scope] = p.ui.ddmanager.droppables[t.scope] || []),
                    p.ui.ddmanager.droppables[t.scope].push(this),
                    ...
                    this.element
                        ...
                        .each(function () {
                            ...
                            if (
                                ...
                                p.ui.intersect(i, p.extend(t, { offset: t.element.offset() }), t.options.tolerance)
                            )
                                return !(s = !0);
                        }),
                    !s &&
            ...
            p.extend(p.ui.droppable, { version: "1.8.22" }),
            ...
            (p.ui.ddmanager = {
                ...
                drop: function (t, e) {
                    var i = !1;
                    return (
                        p.each(p.ui.ddmanager.droppables[t.options.scope] || [], function () {
                            this.options &&
                                (!this.options.disabled && this.visible && p.ui.intersect(t, this, this.options.tolerance) && (i = this._drop.call(this, e) || i),
                ...
                drag: function (n, o) {
                    n.options.refreshPositions && p.ui.ddmanager.prepareOffsets(n, o),
                        p.each(p.ui.ddmanager.droppables[n.options.scope] || [], function () {
    ...
    (function (f, t) {
        f.widget("ui.resizable", f.ui.mouse, {
            ...
            _create: function () {
                ...
                if (
                    ...
                    this.element[0].nodeName.match(/canvas|textarea|input|select|button|img/i) &&
                        (this.element.wrap(
                            f('<div class="ui-wrapper" style="overflow: hidden;"></div>').css({
                    ...
                    (this.handles =
                        t.handles ||
                        (f(".ui-resizable-handle", this.element).length
                ...
                (this._renderAxis = function (t) {
                    for (var e in ((t = t || this.element), this.handles)) {
                        if ((this.handles[e].constructor == String && (this.handles[e] = f(this.handles[e], this.element).show()), this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i))) {
                            var i,
                                s = f(this.handles[e], this.element);
            ...
            _mouseStart: function (t) {
                ...
                e.containment && ((n += f(e.containment).scrollLeft() || 0), (o += f(e.containment).scrollTop() || 0)),
            ...
            _mouseStop: function (t) {
                ...
                if (this._helper) {
                    ...
                    e.animate || this.element.css(f.extend(a, { top: h, left: l })), i.helper.height(i.size.height), i.helper.width(i.size.width), this._helper && !e.animate && this._proportionallyResize();
                }
            ...
            _updateVirtualBoundaries: function (t) {
                var e,
                    ...
                    o,
                    r = this.options;
                (o = { minWidth: p(r.minWidth) ? r.minWidth : 0, maxWidth: p(r.maxWidth) ? r.maxWidth : 1 / 0, minHeight: p(r.minHeight) ? r.minHeight : 0, maxHeight: p(r.maxHeight) ? r.maxHeight : 1 / 0 }),
                    (this._aspectRatio || t) &&
            ...
            _updateRatio: function (t, e) {
                ...
                var i = this.position,
                    ...
                    n = this.axis;
                return (
                    p(t.height) ? (t.width = t.height * this.aspectRatio) : p(t.width) && (t.height = t.width / this.aspectRatio),
            ...
            _proportionallyResize: function () {
                ...
                if (this._proportionallyResizeElements.length)
                    for (var t = this.helper || this.element, e = 0; e < this._proportionallyResizeElements.length; e++) {
                        ...
                        (f.browser.msie && (f(t).is(":hidden") || f(t).parents(":hidden").length)) || i.css({ height: t.height() - this.borderDif[0] - this.borderDif[2] || 0, width: t.width() - this.borderDif[1] - this.borderDif[3] || 0 });
                    }
            },
            ...
            f.extend(f.ui.resizable, { version: "1.8.22" }),
            f.ui.plugin.add("resizable", "alsoResize", {
                start: function (t, e) {
                    ...
                    "object" != typeof i.alsoResize || i.alsoResize.parentNode
                        ...
                        : f.each(i.alsoResize, function (t) {
                              s(t);
                          });
                },
                resize: function (t, o) {
                    var e = f(this).data("resizable"),
                        ...
                        r = { height: e.size.height - s.height || 0, width: e.size.width - s.width || 0, top: e.position.top - n.top || 0, left: e.position.left - n.left || 0 },
                        a = function (t, i) {
                            f(t).each(function () {
                                var t = f(this),
                    ...
                    "object" != typeof i.alsoResize || i.alsoResize.nodeType
                        ? a(i.alsoResize)
                        : f.each(i.alsoResize, function (t, e) {
                              a(t, e);
                          });
                },
                stop: function (t, e) {
                ...
                stop: function (e, t) {
                    ...
                    i.element.animate(f.extend(l, c && h ? { top: c, left: h } : {}), {
                        ...
                        step: function () {
                            ...
                            n && n.length && f(n[0]).css({ width: t.width, height: t.height }), i._updateCache(t), i._propagate("resize", e);
                        },
                    });
                },
            }),
            f.ui.plugin.add("resizable", "containment", {
                start: function (t, e) {
                    ...
                    if (r)
                        if (((i.containerElement = f(r)), /document/.test(o) || o == document))
                            (i.containerOffset = { left: 0, top: 0 }),
                                (i.containerPosition = { left: 0, top: 0 }),
                                (i.parentData = { element: f(document), left: 0, top: 0, width: f(document).width(), height: f(document).height() || document.body.parentNode.scrollHeight });
                        else {
                            var a = f(r),
                                l = [];
                ...
                stop: function (t, e) {
                    ...
                    i._helper && !s.animate && /relative/.test(r.css("position")) && f(this).css({ left: l.left - o.left - n.left, width: h, height: c }),
                        i._helper && !s.animate && /static/.test(r.css("position")) && f(this).css({ left: l.left - o.left - n.left, width: h, height: c });
                },
            }),
            ...
            (h.effects.animateClass = function (o, r, a, l) {
                ...
                h.extend(h.easing, {
                    ...
                    easeInOutElastic: function (t, e, i, s, n) {
                        ...
                        return e < 1 ? -0.5 * a * Math.pow(2, 10 * (e -= 1)) * Math.sin((2 * (e * n - o) * Math.PI) / r) + i : a * Math.pow(2, -10 * (e -= 1)) * Math.sin((2 * (e * n - o) * Math.PI) / r) * 0.5 + s + i;
                    },
    ...
    (function (f, t) {
        f.effects.bounce = function (p) {
            return this.queue(function () {
                ...
                ("show" == i && t.css("opacity", 0).css(a, "pos" == l ? -n : n), "hide" == i && (n /= 2 * o), "hide" != i && o--, "show" == i) &&
                    (((u = { opacity: 1 })[a] = ("pos" == l ? "+=" : "-=") + n), t.animate(u, r / 2, p.options.easing), (n /= 2), o--);
                for (var h = 0; h < o; h++) {
                    var c = {};
                ...
                if ("hide" == i) {
                    ...
                    ((u = { opacity: 0 })[a] = ("pos" == l ? "-=" : "+=") + n),
                        t.animate(u, r / 2, p.options.easing, function () {
                    ...
                    ((d = {})[a] = ("pos" == l ? "-=" : "+=") + n),
                        (c[a] = ("pos" == l ? "+=" : "-=") + n),
                        t.animate(d, r / 2, p.options.easing).animate(c, r / 2, p.options.easing, function () {
    ...
    (function (f, t) {
        f.effects.fold = function (p) {
            return this.queue(function () {
                ...
                var r = f.effects.createWrapper(t).css({ overflow: "hidden" }),
                    a = ("show" == i) != n,
                ...
                (u[l[0]] = "show" == i ? h[0] : s),
                    (d[l[1]] = "show" == i ? h[1] : 0),
                    r.animate(u, o, p.options.easing).animate(d, o, p.options.easing, function () {
        ...
        (g.effects.puff = function (o) {
            ...
            (g.effects.size = function (f) {
                return this.queue(function () {
                    ...
                    var p = { from: { y: t.from.height / u.height, x: t.from.width / u.width }, to: { y: t.to.height / u.height, x: t.to.width / u.width } };
                    ("box" != h && "both" != h) ||
                        (p.from.y != p.to.y && ((e = e.concat(o)), (t.from = g.effects.setTransition(t, o, p.from.y, t.from)), (t.to = g.effects.setTransition(t, o, p.to.y, t.to))),
                        p.from.x != p.to.x && ((e = e.concat(r)), (t.from = g.effects.setTransition(t, r, p.from.x, t.from)), (t.to = g.effects.setTransition(t, r, p.to.x, t.to)))),
                        ("content" == h || "both" == h) && p.from.y != p.to.y && ((e = e.concat(n)), (t.from = g.effects.setTransition(t, n, p.from.y, t.from)), (t.to = g.effects.setTransition(t, n, p.to.y, t.to))),
                        ...
                        ("content" != h && "both" != h) ||
                            ...
                            t.find("*[width]").each(function () {
                                ...
                                var e = t.height(),
                                    i = t.width();
                                (t.from = { height: e * p.from.y, width: i * p.from.x }),
                                    (t.to = { height: e * p.to.y, width: i * p.to.x }),
                                    p.from.y != p.to.y && ((t.from = g.effects.setTransition(t, o, p.from.y, t.from)), (t.to = g.effects.setTransition(t, o, p.to.y, t.to))),
                                    p.from.x != p.to.x && ((t.from = g.effects.setTransition(t, r, p.from.x, t.from)), (t.to = g.effects.setTransition(t, r, p.to.x, t.to))),
                                    t.css(t.from),
                                    t.animate(t.to, f.duration, f.options.easing, function () {
        ...
        d.widget("ui.accordion", {
            ...
            _setOption: function (t, e) {
                d.Widget.prototype._setOption.apply(this, arguments),
                    ...
                    "disabled" == t && this.headers.add(this.headers.next())[e ? "addClass" : "removeClass"]("ui-accordion-disabled ui-state-disabled");
            },
            _keydown: function (t) {
                    ...
                    if (!1 !== s) {
                        ...
                        if (
                            ...
                            i.dpDiv.zIndex($(t).zIndex() + 1),
                                ...
                                $.effects && $.effects[r] ? i.dpDiv.show(r, $.datepicker._get(i, "showOptions"), a, l) : i.dpDiv[r || "show"](r ? a : null, l),
                                (!r || !a) && l(),
            ...
            parseDate: function (i, o, t) {
                ...
                for (
                    var s = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort,
                        n = (t ? t.dayNames : null) || this._defaults.dayNames,
                ...
                for (
                    ...
                    for (var H = 0; H < r[1]; H++) {
                        ...
                        R +=
                            ...
                            L +
                            '">' +
                            (/all|left/.test(L) && 0 == O ? (i ? b : v) : "") +
                            (/all|right/.test(L) && 0 == O ? (i ? v : b) : "") +
                            this._generateMonthYearHeader(t, p, f, u, d, 0 < O || 0 < H, S, T) +
                        ...
                        for (var V = this._daylightSavingAdjust(new Date(f, p, 1 - K)), X = 0; X < Q; X++) {
                            ...
                            for (q = 0; q < 7; q++) {
                                ...
                                (Z +=
                                    ...
                                    ((V.getTime() == W.getTime() && p == t.selectedMonth && t._keyEvent) || (M.getTime() == V.getTime() && M.getTime() == W.getTime()) ? " " + this._dayOverClass : "") +
            ...
            _position: function (t) {
                ...
                t
                    ? (("string" == typeof t || ("object" == typeof t && "0" in t)) &&
                      ...
                      (t = a.extend({}, a.ui.dialog.prototype.options.position, t)))
                    : (t = a.ui.dialog.prototype.options.position),
    ...
    (function (g, t) {
        ...
        (g.fn.position = function (h) {
            ...
            return (
                9 === e.nodeType
                    ? ((c = t.width()), (u = t.height()), (d = { top: 0, left: 0 }))
                    : e.setTimeout
                    ? ((c = t.width()), (u = t.height()), (d = { top: t.scrollTop(), left: t.scrollLeft() }))
                    : e.preventDefault
                    ? ((h.at = "left top"), (c = u = 0), (d = { top: h.of.pageY, left: h.of.pageX }))
                    : ((c = t.outerWidth()), (u = t.outerHeight()), (d = t.offset())),
                ...
                this.each(function () {
                    ...
                    "right" === h.my[0] ? (l.left -= s) : h.my[0] === m && (l.left -= s / 2),
                        ...
                        g.each(["left", "top"], function (t, e) {
                            g.ui.position[p[t]] && g.ui.position[p[t]][e](l, { targetWidth: c, targetHeight: u, elemWidth: s, elemHeight: n, collisionPosition: i, collisionWidth: r, collisionHeight: a, offset: f, my: h.my, at: h.at });
                        }),
        ...
        p.widget("ui.tabs", {
            ...
            _tabify: function (t) {
                ...
                (this.list = this.element.find("ol,ul").eq(0)),
                    (this.lis = p(" > li:has(a[href])", this.list)),
                    ...
                    t
                        ? (this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all"),
                          ...
                          (l.disabled = p
                              .unique(
                                  l.disabled.concat(
                                      p.map(this.lis.filter(".ui-state-disabled"), function (t, e) {
                                          return a.lis.index(t);
                                      })
                                  )
                              )
                              .sort()),
                          -1 != p.inArray(l.selected, l.disabled) && l.disabled.splice(p.inArray(l.selected, l.disabled), 1),
                ...
                var u = n
                        ? function (t, e) {
                              p(t).closest("li").addClass("ui-tabs-selected ui-state-active"),
                                  e
                                      .hide()
            ...
            add: function (t, e, i) {
                ...
                return (
                    a.length || (a = p(n.panelTemplate).attr("id", r).data("destroy.tabs", !0)),
                    ...
                    (n.disabled = p.map(n.disabled, function (t, e) {
                        return i <= t ? ++t : t;
                    })),
                    this._tabify(),
            ...
            remove: function (i) {
                ...
                return (
                    ...
                    (t.disabled = p.map(
                        p.grep(t.disabled, function (t, e) {
                            return t != i;
                        }),
                        function (t, e) {
                            return i <= t ? --t : t;
            ...
            enable: function (i) {
                i = this._getIndex(i);
                var t = this.options;
                if (-1 != p.inArray(i, t.disabled))
                    return (
                        this.lis.eq(i).removeClass("ui-state-disabled"),
                        (t.disabled = p.grep(t.disabled, function (t, e) {
                            return t != i;
                        })),
            ...
            p.extend(p.ui.tabs, { version: "1.8.22" }),
                        ...
                        for (n = 0, o = (t = d(t)).length; n < o; n++)
                            (s = null),
                                (a = typeof (r = t[n])) === g
                                    ? (s = h.get(r))
                                    : "string" === a
                                    ? (s = document.getElementById(r.replace("#", "")))
                                    : "object" === a && (r instanceof jQuery && r.length && (r = r[0]), r.nodeType && h.each(c)),
                                s && l.push(s);
                    return !1 === i ? l : u(l);
                },
            ...
            h.extend(h.validator, {
                ...
                attributeRules: function (t) {
                    ...
                    for (var n in h.validator.methods) {
                        var o;
                        "required" === n ? ("" === (o = i.get(0).getAttribute(n)) && (o = !0), (o = !!o)) : (o = i.attr(n)),
            ...
            initToggle: function (t) {
                return (
                    this.toggleElement.length ||
                        ...
                        t.touchSupport ? (this.toggleElement.css(t.touchStyles), this.element.on(t.attachToTouchEvent, o.proxy(this.toggleTouchEvent, this))) : this.toggleElement.on(t.attachToEvent, o.proxy(this.toggleEvent, this)),
    ...
    (function (t) {
        ...
        var t,
            ...
            c = { orientation: { horizontal: { dimension: "width", direction: "left", directionStyle: "left", coordinate: "x" }, vertical: { dimension: "height", direction: "top", directionStyle: "bottom", coordinate: "y" } } };
        function i(t, e) {
            var i = (function (t) {
            ...
            if (s) {
                for (var a = 0; a < s; a++)
                    (n[a] = i[a].style.cssText),
                        i[a].style.setProperty ? i[a].style.setProperty("display", "block", "important") : (i[a].style.cssText += ";display: block !important"),
                        (i[a].style.height = "0"),
        ...
        function u(t, e) {
            if (
                ...
                (this.$element = o(t)),
                (this.options = o.extend({}, h, e)),
                (this.polyfill = this.options.polyfill),
                (this.orientation = this.$element[0].getAttribute("data-orientation") || this.options.orientation),
                (this.onInit = this.options.onInit),
                (this.onSlide = this.options.onSlide),
                (this.onSlideEnd = this.options.onSlideEnd),
                (this.DIMENSION = c.orientation[this.orientation].dimension),
                (this.DIRECTION = c.orientation[this.orientation].direction),
                (this.DIRECTION_STYLE = c.orientation[this.orientation].directionStyle),
                (this.COORDINATE = c.orientation[this.orientation].coordinate),
                this.polyfill && l)
            )
                return !1;
            (this.identifier = "js-" + r + "-" + a++),
                ...
                (this.$range = o('<div class="' + this.options.rangeClass + " " + this.options[this.orientation + "Class"] + '" id="' + this.identifier + '" />')
        ...
        return (
            ...
            (u.prototype.update = function (t, e) {
                (t = t || !1) &&
                    ((this.min = s(this.$element[0].getAttribute("min"), 0)),
                    (this.max = s(this.$element[0].getAttribute("max"), 100)),
                    (this.value = s(this.$element[0].value, Math.round(this.min + (this.max - this.min) / 2))),
                    (this.step = s(this.$element[0].getAttribute("step"), 1))),
                    (this.handleDimension = i(this.$handle[0], "offset" + n(this.DIMENSION))),
                    (this.rangeDimension = i(this.$range[0], "offset" + n(this.DIMENSION))),
            ...
            (u.prototype.getRelativePosition = function (t) {
                var e = n(this.COORDINATE),
                    ...
                    s = 0;
                return (
                    void 0 !== t.originalEvent["client" + e]
                        ? (s = t.originalEvent["client" + e])
                        : t.originalEvent.touches && t.originalEvent.touches[0] && void 0 !== t.originalEvent.touches[0]["client" + e]
                        ? (s = t.originalEvent.touches[0]["client" + e])
                        : t.currentPoint && void 0 !== t.currentPoint[this.COORDINATE] && (s = t.currentPoint[this.COORDINATE]),
                    s - i
                );
            }),
